...
export default function Servicos_() {
  return (
    <div className="bg-white py-10 relative" id="servicos">
      <div className=" flex items-center justify-center  container mx-auto px-4 text-center">
        <h2 className=" text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl  font-bold">
          ...
          <div className="flex justify-center items-center">
            <hr className=" w-[10rem] md:w-[18rem] border-t-2 mt-4 border-trueGray-200  "></hr>
          </div>
        </h2>
      </div>
      <div className="container mx-auto  relative py-8 md:py-10  " id="servicos">
